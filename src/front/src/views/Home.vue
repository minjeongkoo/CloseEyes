<template>
    <div class="homeView">
      <!-- BI Area -->
      <svg class="homeLogo-animatioon" xmlns="http://www.w3.org/2000/svg" width="85" height="64" viewBox="0 0 85 64">
      ...
      <!-- Support Info -->
      <div>
        <div><img src=""><span>Github</span></div>
        <div><img src=""><span>문제 신고 & 기능 문의</span></div>
        <div><img src=""><span>Supported Rekenzo_</span></div>
      </div>
    </div>
</template>
